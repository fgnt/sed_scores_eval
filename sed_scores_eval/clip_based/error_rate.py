...
def error_rate_curve(scores, ground_truth, *, deltas=None, num_jobs=1):
    """Compute clip-based error rates with corresponding insertion rate,
...
def error_rate(scores, ground_truth, threshold, *, deltas=None, num_jobs=1):
    """Compute clip-based error rates with corresponding insertion rate,
...
def best_error_rate(
    ...
    """Get the best possible (macro-averaged) clip-based error rate with
    corresponding insertion rate, deletion rate, intermediate statistics and
    decision threshold
